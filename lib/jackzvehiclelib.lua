-- GENERATED ON Tuesday 30th OF August 2022 AT 06:48:49 PM
-- AUTOGENERATED CODE --
local SCRIPT_SOURCE = "REPO"
local SCRIPT_BRANCH = "release"
local BRANCH_LAST_COMMIT = "f22ad12b7fe982e1ddd0e3dc36c67236004b17eb"
local SCRIPT_BRANCH_IDS = {"release","master"}
local SCRIPT_BRANCH_NAMES = {{"release"},{"dev"}}
